...
public:
    ...
    virtual void saveRecentSearches(const AtomicString& name, const Vector<RecentSearch>& searchItems);
    virtual void loadRecentSearches(const AtomicString& name, Vector<RecentSearch>& searchItems);
