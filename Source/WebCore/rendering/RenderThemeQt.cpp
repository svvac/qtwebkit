...
int RenderThemeQt::baselinePosition(const RenderBox& box) const
{
...
bool RenderThemeQt::paintSearchField(const RenderObject& o, const PaintInfo& pi, const IntRect& r)
{
...
FloatRect RenderThemeQt::convertToPaintingRect(const RenderObject& inputRenderer, const RenderObject& partRenderer, const FloatRect& inputRect, const IntRect& r) const
{
...
bool RenderThemeQt::paintSearchFieldCancelButton(const RenderObject& o, const PaintInfo& pi, const IntRect& r)
{
    IntRect bounds = r;
    ASSERT(o.parent());
    ...
    bounds.setHeight(qMin(parentBox.width(), qMin(parentBox.height(), bounds.height())));
...
bool RenderThemeQt::paintSearchFieldDecoration(const RenderObject& o, const PaintInfo& pi, const IntRect& r)
{
    notImplemented();
...
bool RenderThemeQt::paintSearchFieldResultsDecorationPart(const RenderObject& o, const PaintInfo& pi, const IntRect& r)
{
    notImplemented();
